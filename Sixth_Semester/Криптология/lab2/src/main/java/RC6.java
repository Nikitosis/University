...
public class RC6 {
    ...
    private static byte[] decryption(byte[] keySchArray) {
        ...
        int A = temp_data_decryption[0];
        int B = temp_data_decryption[1];
        int C = temp_data_decryption[2];
        int D = temp_data_decryption[3];
    ...
    private static String runEncryption(){
        ...
        try {
            ...
            String userKey = input_key_val[1];
            userKey = userKey.replace(" ", "");

            byte[] key = hexStringToByteArray(userKey);
    ...
    private static String runDecryption(){
        ...
        try {
            ...
            String key_value = bf.readLine();
            String[] input_key_val = key_value.split(":");
            String tempString = input_key_val[1];
